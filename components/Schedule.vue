    ...
    <div class="section" :style="styles">
      ...
      <div class="schedule-container">
        ...
        <div class="event-list-container">
          ...
          <div
            v-if="!dataLoaded || Object.keys(schedule).length === 0"
            class="coming-soon-inline"
          >
            <h2>Coming Soon</h2>
          </div>
  ...
  for (const [dateTime, data] of Object.entries(schedule)) {
    ...
    if (firstEntry) {
      ...
      data.events = data.events.map(
        (event: CalculatedEvent): CalculatedEvent => {
